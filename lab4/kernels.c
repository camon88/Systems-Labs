...
void smooth(int dim, pixel *src, pixel *dst)
{
        ...
        dst[t - 1].green = ((src[t - 1].green + src[t - dim - 1].green + src[t - dim - 2].green + src[t - 2].green)>>2);
        ...
        for(i = 1; i < dim - 1; i++)
        {
                dst[i].red = ((src[i].red + src[i - 1].red + src[i + 1].red + src[dim + i - 1].red + src[dim + i].red + src[dim + i + 1].red)/6);
                dst[i].blue = ((src[i].blue + src[i - 1].blue + src[i + 1].blue + src[dim + i - 1].blue + src[dim +i].blue + src[dim + i + 1].blue)/6);
                dst[i].green = ((src[i].green + src[i - 1].green + src[i + 1].green + src[dim + i - 1].green + src[dim + i].green + src[dim + i + 1].green)/6);
        }

        //Bottom
        for(i = j + 1; i < t - 1; i++)
        {
                dst[i].red = ((src[i].red + src[i - 1].red + src[i + 1].red + src[i - dim - 1].red + src[i - dim].red + src[i - dim + 1].red)/6);
                dst[i].blue = ((src[i].blue + src[i - 1].blue + src[i + 1].blue + src[i - dim - 1].blue + src[i - dim].blue + src[i - dim + 1].blue)/6);
                dst[i].green = ((src[i].green + src[i - 1].green + src[i + 1].green + src[i - dim - 1].green + src[i - dim].green + src[i - dim + 1].green)/6);
        }
        ...
        for(i = 1; i < dim - 1; i++)
        {
                dst[x].red = ((src[x].red + src[x - dim].red + src[x - dim + 1].red + src[x + 1].red + src[x + dim].red + src[x + dim + 1].red)/6);
                dst[x].blue = (src[x].blue + src[x - dim].blue + src[x - dim + 1].blue + src[x + 1].blue + src[x + dim].blue + src[x + dim + 1].blue)/6;
                dst[x].green = (src[x].green + src[x - dim].green + src[x - dim + 1].green + src[x + 1].green + src[x + dim].green + src[x + dim + 1].green)/6;
                x = x + dim;
        }
        ...
        for(i = 1; i < dim - 1; i++)
        {
                dst[y].red = ((src[y].red + src[y - dim].red + src[y - dim - 1].red + src[y - 1].red + src[y + dim].red + src[y + dim - 1].red)/6);
                dst[y].blue = (src[y].blue + src[y - dim].blue + src[y - dim - 1].blue + src[y - 1].blue + src[y + dim].blue + src[y + dim - 1].blue)/6;
                dst[y].green = (src[y].green + src[y - dim].green + src[y - dim - 1].green + src[y - 1].green + src[y + dim].green + src[y + dim - 1].green)/6;
                y = y + dim;
        }
